...
PRODUCTS = [
  ...
  { cat: :"3dm1_printer", name: :"3dm1_printer_kit", 
    ...
    price: 499, original_price: 205, image: 1 }.merge(THREEDM1_INFOS),
  ...
  # electronics
    ...
    { cat: :electronics, name: :fan, 
      ...
      price: 0.5, original_price: 2.50, image: 25, 
      description: "3D printer axial fan 40x40x10mm", description_it: "ventola per stampante 3D. Misure: 40x40x10mm." 
    },
